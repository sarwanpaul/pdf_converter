 <style type="text/css">
	.csvTable tr td{white-space: nowrap}
	  .csvTable tr:nth-child(even) {background: #CCC;font-size:12px;color:paleturquoise;}
	    		.csvTable tr:nth-child(odd) {background: #FFF;font-size:12px;color:palegoldenrod;}  
